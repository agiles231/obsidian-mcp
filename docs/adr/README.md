...
| [0012](0012-filesystem-native-ownership-boundary.md) | Filesystem-native ownership boundary: own on-disk specs, not plugin runtime | Accepted |
| [0013](0013-tool-design-orthogonal-primitives.md) | Tool design: orthogonal primitives, specific tools only for invariants | Accepted |
